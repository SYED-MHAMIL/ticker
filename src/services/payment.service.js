  ...
  metadata: {
    ...
    withTransaction(async (client) => {
        if(get_booking_seat.seat_status !== 'reserved'){
           ...
           await paymentRepo.setup_payment(create_payment_intent.metadata?.booking_id,create_payment_intent.amount,create_payment_intent.currency,'pending','stripe',client)
